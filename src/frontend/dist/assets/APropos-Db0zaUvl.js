...
function AProposPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "a_propos.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto text-center text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Une entreprise sénégalaise engagée pour vous offrir les meilleures prestations en voyage, immobilier et propreté."
            }
          )
        ] })
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", "data-aos": "fade-up", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                children: "Notre Mission & Notre Vision"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: missionVision.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-4", children: item.emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h3",
                  {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-aos": "fade-right", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                children: "Une Vision, Trois Expertises"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Assirik Tours est une entreprise sénégalaise basée à Dakar, offrant des services professionnels à travers trois départements complémentaires : Voyages, Immobilier et Nettoiement."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "#555", fontFamily: "Open Sans, sans-serif" },
                children: "Notre mission est de vous accompagner avec expertise, proximité et qualité dans tous vos projets, qu'il s'agisse de voyager, d'acquérir un bien ou d'entretenir vos espaces."
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-aos": "fade-left", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4", children: [
            {
              icon: "fa-plane",
          ...
          ].map((dep, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-6", children: keyStats.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl mb-3", children: stat.emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-6", children: values.map((v, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-6", children: teamMembers.map((member, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    children: member.dept
                  }
                )
              ]
            },
            member.initials + member.role
          )) })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: certifications.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  ...
                  style: { fontFamily: "Montserrat, sans-serif" },
                  children: "Prêt à Travailler Avec Nous ?"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Contactez-nous pour discuter de votre projet et obtenir un devis personnalisé."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
