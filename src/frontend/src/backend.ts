...
export class Backend implements backendInterface {
    ...
    async getContacts(): Promise<Array<DemandeBase>> {
        if (this.processError) {
            try {
    ...
    async getDemandesImmobilier(): Promise<Array<DemandeBase>> {
        if (this.processError) {
            try {
    ...
    async getDemandesNettoiement(): Promise<Array<DemandeBase>> {
        if (this.processError) {
            try {
    ...
    async getDemandesVoyages(): Promise<Array<DemandeBase>> {
        if (this.processError) {
            try {
    ...
    async submitContact(arg0: DemandeInput): Promise<RecordId> {
        if (this.processError) {
            try {
    ...
    async submitImmobilier(arg0: DemandeInput): Promise<RecordId> {
        if (this.processError) {
            try {
    ...
    async submitNettoiement(arg0: DemandeInput): Promise<RecordId> {
        if (this.processError) {
            try {
    ...
    async submitVoyage(arg0: DemandeInput): Promise<RecordId> {
        if (this.processError) {
            try {
    ...
    async updateStatut(arg0: string, arg1: RecordId, arg2: Statut): Promise<boolean> {
        if (this.processError) {
            try {
